...
export class FacilitiesService {
  ...
  async update(id: number, updateFacilityDto: UpdateFacilityDto) {
    try {
      ...
      const faciBefore = (await this.findOne(id)).data;
      ...
      if (
        updateFacilityDto.faci_low_price != faciBefore.faci_low_price ||
        updateFacilityDto.faci_high_price != faciBefore.faci_high_price ||
        updateFacilityDto.faci_rate_price != faciBefore.faci_rate_price ||
        updateFacilityDto.faci_discount != faciBefore.faci_discount ||
        updateFacilityDto.faci_tax_rate != faciBefore.faci_tax_rate
      ) {
