      ...
      <div className="container px-4 pt-10 ">
        ...
        <div className="header flex justify-between mb-5">
          ...
          <h5 className="text-textSecondary">
            Dashboard /{" "}
            <span className="text-textPurple font-poppins-semibold">
        ...
        <div className="hotel-info-container mt-5 relative flex items-center content-center">
          ...
          <div className="hotel-info flex justify-between px-5 absolute top-50 w-full">
            ...
            <div className="info-2 flex flex-col justify-center items-center">
          ...
          <table class="w-full min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-800">
              <tr className="border-t border-slate-200 text-textGray">
                <th className="px-3 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400 whitespace-nowrap">
                  No
                </th>
                <th className="px-3 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400 whitespace-nowrap">
                  Facility Name
              ...
              {status != 400 &&
                ...
                facilities.map(faci => (
                  <tr
                    ...
                    key={faci.faci_id}
                  >
                    <td className="px-3 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                      {faci.row_number}
                    </td>
                    <td className="px-3 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                      {faci.faci_name}
                    ...
                    <td className="px-3 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                      {faci.faci_room_number}
                    </td>
                    <td className="px-3 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                      {faci.faci_max_number}
                    </td>
