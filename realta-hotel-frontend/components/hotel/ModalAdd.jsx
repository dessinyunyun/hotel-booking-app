            ...
            >
              ...
              <div className="relative p-6 flex-auto">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="border w-full placeholder:italic placeholder:text-slate-400 block bg-white h-40 border-slate-300 rounded-lg py-4 px-3 shadow-sm focus:outline-none focus:border-bgPrimary focus:ring-bgPrimary focus:ring-1 sm:text-sm resize-none "
              ...
              <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                ...
                <button
                  for="submit"
                  type="submit"
                  className=" bg-bgPrimary/90  hover:bg-bgPrimary text-white active:bg-bgPrimary   font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                >
                  Add Hotel
                </button>
              </div>
