          ...
          <form onSubmit={submitAddHotel} ref={FormRef}>
            ...
            >
              ...
              <div className="relative p-6 flex-auto">
                ...
                <div className="address mb-6 items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {address[0].addr_id.length != 0 ? (
                          ...
                          <li
                            className="py-2 px-5 hover:bg-bgPrimary/10 cursor-pointe cursor-pointer flex content-center items-center gap-2"
                            onClick={() => {
                              setShowAddress(false)
                              props.setShowaAddAddress(true)
                              props.setShowModalAdd(false)
                            }}
                          >
                            <Plus
                              ...
                              width="10"
                              height="10"
                              className="border box-content p-1 rounded-full"
                            />{" "}
                            add
                          </li>
                        )}
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="border w-full placeholder:italic placeholder:text-slate-400 block bg-white h-28 border-slate-300 rounded-lg py-4 px-3 shadow-sm focus:outline-none focus:border-bgPrimary focus:ring-bgPrimary focus:ring-1 sm:text-sm resize-none "
